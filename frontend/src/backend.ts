...
export class Backend implements backendInterface {
    ...
    async addEmployee(arg0: EmployeeDetails): Promise<string> {
        if (this.processError) {
            try {
    ...
    async bulkCreateEmployees(arg0: Array<BulkEmployeeRecord>): Promise<Array<BulkCreateStatus>> {
        if (this.processError) {
            try {
                const result = await this.actor.bulkCreateEmployees(to_candid_vec_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateLetter(arg0: string, arg1: string, arg2: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.generateLetter(arg0, arg1, await to_candid_ExternalBlob_n15(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEmployee(arg0: string): Promise<EmployeeProfile> {
        if (this.processError) {
            try {
                ...
                return from_candid_EmployeeProfile_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async registerNewEmployee(arg0: EmployeeProfile): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.registerNewEmployee(to_candid_EmployeeProfile_n37(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadPayslip(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPayslip(arg0, arg1, arg2, await to_candid_ExternalBlob_n15(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_EmployeeProfile_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EmployeeProfile): EmployeeProfile {
    return from_candid_record_n18(_uploadFile, _downloadFile, value);
}
function from_candid_EmployeeRecord_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EmployeeRecord): EmployeeRecord {
    return from_candid_record_n29(_uploadFile, _downloadFile, value);
}
function from_candid_EmployeeRole_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EmployeeRole): EmployeeRole {
...
async function from_candid_Letter_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Letter): Promise<Letter> {
    return await from_candid_record_n32(_uploadFile, _downloadFile, value);
}
async function from_candid_Payslip_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Payslip): Promise<Payslip> {
...
function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        status: value.status,
        personalEmail: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.personalEmail)),
        role: from_candid_EmployeeRole_n20(_uploadFile, _downloadFile, value.role),
...
async function from_candid_record_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        employeeId: value.employeeId,
        document: await from_candid_ExternalBlob_n33(_uploadFile, _downloadFile, value.document),
...
async function from_candid_record_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        year: value.year,
        payslipDocument: await from_candid_ExternalBlob_n33(_uploadFile, _downloadFile, value.payslipDocument),
        employeeId: value.employeeId
    };
}
...
function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_EmployeeProfile>): Array<EmployeeProfile> {
    return value.map((x)=>from_candid_EmployeeProfile_n17(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_EmployeeRecord>): Array<EmployeeRecord> {
    return value.map((x)=>from_candid_EmployeeRecord_n28(_uploadFile, _downloadFile, x));
}
async function from_candid_vec_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Letter>): Promise<Array<Letter>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Letter_n31(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Payslip>): Promise<Array<Payslip>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Payslip_n35(_uploadFile, _downloadFile, x)));
}
function to_candid_BulkEmployeeRecord_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BulkEmployeeRecord): _BulkEmployeeRecord {
    return to_candid_record_n12(_uploadFile, _downloadFile, value);
}
function to_candid_EmployeeProfile_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: EmployeeProfile): _EmployeeProfile {
...
function to_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<BulkEmployeeRecord>): Array<_BulkEmployeeRecord> {
    return value.map((x)=>to_candid_BulkEmployeeRecord_n11(_uploadFile, _downloadFile, x));
}
